...
![Image 2: Hydrological construction and rehabilitation of canals.](channels.png){fig-alt="The photos shown are property of the Primary Production Laboratory (CINVESTAV- IPN), except for those where reference is made to its author." fig-align="center" width="55%"}
...
|:----------:|:----------:|:----------:|:----------:|:----------:|:----------:|
| Mexico  |                        Yes                         |                           Partial                            | Inconclusive or undefined  |        Inconclusive or undefined        | Carbon rights are inconclusive or undefined |
